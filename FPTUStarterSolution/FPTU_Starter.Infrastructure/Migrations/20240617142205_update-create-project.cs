...
{
    public partial class updatecreateproject : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BackerId = table.Column<string>(type: "nvarchar(450)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Wallets", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Wallets_AspNetUsers_BackerId",
                        column: x => x.BackerId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AboutUs_Projects_ProjectId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_WithdrawRequests_Projects_ProjectId",
                        column: x => x.ProjectId,
                        principalTable: "Projects",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DonateAmount = table.Column<double>(type: "float", nullable: false),
                    DonateDate = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_PackageBackers", x => new { x.ProjectPackageId, x.UserId });
                    table.ForeignKey(
                        name: "FK_PackageBackers_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PackageBackers_Packages_ProjectPackageId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RewardItemsId = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProjectPackageRewardItem", x => new { x.PackagesId, x.RewardItemsId });
                    table.ForeignKey(
                        name: "FK_ProjectPackageRewardItem_Packages_PackagesId",
                        column: x => x.PackagesId,
                        principalTable: "Packages",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProjectPackageRewardItem_RewardItem_RewardItemsId",
                        column: x => x.RewardItemsId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProjectPackageRewardItem_RewardItemsId",
                table: "ProjectPackageRewardItem",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Wallets_BackerId",
                table: "Wallets",
                column: "BackerId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_WithdrawRequests_ProjectId",
